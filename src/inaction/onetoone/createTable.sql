...
--住所IDをユニークに
ALTER TABLE USER_ONETOONE ADD CONSTRAINT USER_ADDRESS_ONETOONE_HOME_UNIQUE unique(home_address_id);
ALTER TABLE USER_ONETOONE ADD CONSTRAINT USER_ADDRESS_ONETOONE_BILLING_UNIQUE unique(billing_address_id);
